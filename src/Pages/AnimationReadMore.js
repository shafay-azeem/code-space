                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      <h3>{t("AnimationReadMoreHeading1")}</h3>
                      {/* <h4
                      style={{
                        fontSize: "16px",
                        letterSpacing: "1px",
                    ...
                    >
                      ...
                      <p>{t("AnimationReadMoreDescription")}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="me-grid">
              <div className="container">
                <div className="row">
                  ...
                  <div
                    className="col-md-8 col-sm-6 col-xs-12 about-col"
                  ...
                  >
                    <div className="about-details wow fadeIn">
                      <div className="main-title left-title text-left wow fadeIn">
                        ...
                        >
                          {t("AnimationReadMoreReasonsHeading")}
                        </h4>
                        <div className="underline1 no-margin"></div>
                        <div className="underline2 no-margin"></div>
                      </div>
                      <p className="wow fadeIn">
                        {t("AnimationReadMoreReasons1")}
                        <br></br> <br></br>
                        {t("AnimationReadMoreReasons2")}
                        <br></br> <br></br>
                        {t("AnimationReadMoreReasons3")}
                        <br></br> <br></br>
                        {t("AnimationReadMoreReasons4")}
                        <br></br> <br></br>
                        {t("AnimationReadMoreReasons5")}
                        <br></br> <br></br>
                        {t("AnimationReadMoreReasons6")}
                      </p>
                    </div>
                  </div>
                </div>
...
export default AnimationReadMore;
